...
- Missing data for last month → caused empty result  
---
...
**(Cancelled appointments last quarter)**  
   - Issue: Query does not correctly filter last quarter  
   - Reason: Missing proper date range logic  
